...
import 'package:movie_ticket_purchase_app/src/utility/constant/constants.dart';
...
class FaceIDPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final canBlink =
        animation.controller.value >= 0.6 && animation.controller.value <= 0.65;
    final canshowChecl1 = animation.controller.value >= 0.9;
    final canshowCheck2 = animation.controller.value >= 0.95;
    ...
    final leftEyeP2 = Offset(oneThird + moveX, oneThird + moveY + eyeLength);
    canvas.drawLine(leftEyeP1, leftEyeP2, facePaint);

    final rightEyeP1 = Offset(twoThird + moveX, oneThird + moveY);
    final rightEyeP2 = Offset(twoThird + moveX, oneThird + moveY + eyeLength);
    ...
    final nosePath = Path()
      ..moveTo(oneHalf + noseOffsetX + moveX * offsetFactor, oneThird + moveY)
      ..lineTo(
    ...
    final circle = Paint()
      ..style = PaintingStyle.fill
      ..color = AppColors.primaryColor
      ..strokeMiterLimit = s * 0.025;
    final capRadius = s * 0.03;
    ...
    final check1 = Paint()
      ..strokeCap = StrokeCap.round
      ..color = canshowChecl1 ? AppColors.primaryColor : Colors.transparent
      ..strokeWidth = strokeWidth;
    canvas.drawLine(
      Offset(s * 0.275, oneHalf),
